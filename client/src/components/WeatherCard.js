  ...
  return (
    <Card className='text-center mt-4'>
      ...
      <ListGroup className='list-group-flush'>
        ...
        <ListGroupItem>Temperature: {props.temp}º</ListGroupItem>
        <ListGroupItem>Max temperature: {props.max}º</ListGroupItem>
        <ListGroupItem>Min temperature: {props.min}º</ListGroupItem>
